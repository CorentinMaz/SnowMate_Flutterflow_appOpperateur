...
import 'first_connection_model.dart';
export 'first_connection_model.dart';

class FirstConnectionWidget extends StatefulWidget {
  const FirstConnectionWidget({super.key});

  @override
  State<FirstConnectionWidget> createState() => _FirstConnectionWidgetState();
}

class _FirstConnectionWidgetState extends State<FirstConnectionWidget> {
  late FirstConnectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FirstConnectionModel());
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (_model.passwordTextController1.text ==
                      ...
                      _model.apiResult2l6 = await FirstConnectionCall.call(
                        operatorsEmail: _model.addressTextController.text,
                        password: _model.passwordTextController1.text,
                      );

                      if ((_model.apiResult2l6?.succeeded ?? true)) {
                        context.pushNamed('Connexion');

                        await actions.showToastNotification(
                          context,
                          'Votre mot de passe a bien été ajouté',
                          'success',
                        );
                      } else {
                        await actions.showToastNotification(
