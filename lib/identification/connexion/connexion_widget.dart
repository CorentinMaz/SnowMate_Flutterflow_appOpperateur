              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    _model.apiResultdn6 = await LoginCall.call(
                      email: _model.addressTextController.text,
                      password: _model.passwordTextController.text,
                    );

                    if ((_model.apiResultdn6?.succeeded ?? true)) {
                      _model.apiResults68 = await GetOperateurConnectCall.call(
                        authToken: getJsonField(
                          (_model.apiResultdn6?.jsonBody ?? ''),
                          r'''$.authToken''',
                        ).toString(),
                      );

                      if ((_model.apiResults68?.succeeded ?? true)) {
                        FFAppState().authToken = getJsonField(
                          (_model.apiResultdn6?.jsonBody ?? ''),
                          r'''$.authToken''',
                        ).toString();
                        FFAppState().operator =
                            (_model.apiResults68?.jsonBody ?? '');
                        safeSetState(() {});
              ...
              Padding(
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: 'Vous n\'avez pas de mot de passe ? ',
                      ...
                      TextSpan(
                        ...
                        recognizer: TapGestureRecognizer()
                          ..onTap = () async {
                            context.pushNamed('FirstConnection');
                          },
                      )
                    ],
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
