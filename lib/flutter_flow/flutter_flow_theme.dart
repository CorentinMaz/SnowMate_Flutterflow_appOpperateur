...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1B7299);
  late Color secondary = const Color(0xFFF7F7F7);
  late Color tertiary = const Color(0xFF39897E);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF8FAFA);
  late Color accent1 = const Color(0xFF0D4660);
  late Color accent2 = const Color(0xFF374955);
  late Color accent3 = const Color(0xFF1B7299);
  late Color accent4 = const Color(0xCCC4C4C4);
  late Color success = const Color(0xFF39897E);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFF93353B);
